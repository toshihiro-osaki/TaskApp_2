...
public class InputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.done_button).setOnClickListener(mOnDoneClickListener);// [決定]ボタン
        mTitleEdit = (EditText)findViewById(R.id.title_edit_text);
        mContentEdit = (EditText)findViewById(R.id.content_edit_text);
        mCategoryEdit = (EditText)findViewById(R.id.category_edit_text); //カテゴリ　←追加
        ...
        if (mTask == null) {
            ...
            mCategoryEdit.setText(mTask.getCategory()); //カテゴリ　←追加
    ...
    private void addTask() {
        ...
        String category = mCategoryEdit.getText().toString(); //カテゴリ　←追加

        mTask.setTitle(title);
        mTask.setContents(content);
        mTask.setCategory(category); //カテゴリ　←追加
